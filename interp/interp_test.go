...
func run(t *testing.T, dir, input string, success successPredicate) bool {
	...
	_, exitCode := interp.Interpret(mainPkg, 0, &types.StdSizes{WordSize: 8, MaxAlign: 8}, inputs[0], []string{}, ext, capturedOutput)

	// The definition of success varies with each file.
	if err := success(exitCode, (*capturedOutput).String()); err != nil {
