// Tests of call chaining f(g()) when g has multiple return Ivalues (MRVs).
...
func h() (i interface{}, ok bool) {
	...
	i, ok = m[1] // string->interface{} conversion within multi-Ivalued expression
	return
}
...
func h2() (i interface{}, ok bool) {
	...
	ch <- "hi"
	i, ok = <-ch // string->interface{} conversion within multi-Ivalued expression
	return
}
